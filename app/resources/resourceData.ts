...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    "seoTitle": "Green Pentagon Cannabis Resources | Menu and Shopping Guides",
    "description": "Resource guides for shopping the Green Pentagon Cannabis menu in Toronto, including flower, value, pre-rolls, and Native smokes where listed.",
    "eyebrow": "Resource Centre",
    "intro": "Welcome to the Green Pentagon Cannabis resource centre. This is the no-stress corner for shoppers who want the menu to make sense before they visit. Pick the product lane, compare what matters, then use the current menu or staff for details that change.",
    "cards": [
      {
        "title": "Menu Guide",
    ...
    "sections": [
      ...
      {
        "heading": "Local Notes For Parkdale / Queen West",
        "body": "Green Pentagon Cannabis serves shoppers around Parkdale / Queen West, Queen St W, Lansdowne, Parkdale. If you searched for a weed dispensary in Parkdale / Queen West, this resource section keeps the visit simple: right store, right menu lane, right next step."
      }
    ]
  },
  {
    "slug": "menu-guide",
    "title": "How To Shop The Green Pentagon Cannabis Menu",
    "seoTitle": "Green Pentagon Cannabis Menu Guide | Toronto Weed Dispensary Tips",
    "description": "How to shop the Green Pentagon Cannabis menu by category, with natural tips for flower, pre-rolls, edibles, THC vapes, concentrates, and value shopping.",
    "eyebrow": "Menu Guide",
  ...
  {
    "slug": "flower-guide",
    "title": "Green Pentagon Cannabis Flower Guide",
    "seoTitle": "Green Pentagon Cannabis Flower Guide | Exotic, Premium, Budget",
    "description": "Compare exotic flower, premium flower, budget weed, cheap weed, and affordable weed at Green Pentagon Cannabis without guessing.",
  ...
  {
    "slug": "value-guide",
    "title": "Green Pentagon Cannabis Value Guide",
    "seoTitle": "Green Pentagon Cannabis Value Guide | Cheap Weed and Budget Weed",
    "description": "A practical value guide for shoppers comparing cheap weed, budget weed, affordable weed, and menu categories at Green Pentagon Cannabis.",
    "eyebrow": "Value Guide",
  ...
  {
    "slug": "pre-roll-guide",
    "title": "Green Pentagon Cannabis Pre-Roll Guide",
    "seoTitle": "Green Pentagon Cannabis Pre-Roll Guide | Toronto Cannabis Menu Tips",
    "description": "How to compare pre-rolls at Green Pentagon Cannabis without mixing them up with flower, edibles, THC vapes, and concentrates.",
  ...
  },
  {
    ...
    "title": "Green Pentagon Cannabis Resource Centre Launch",
    "seoTitle": "Green Pentagon Cannabis Resource Centre Launch",
    "description": "The Green Pentagon Cannabis resource centre gives shoppers cleaner menu guides for flower, value, pre-rolls, and store visits.",
  ...
  {
    "slug": "native-smokes",
    "title": "Green Pentagon Cannabis Native Smokes Resource",
    "seoTitle": "Green Pentagon Cannabis Native Smokes | $25 Carton Notes",
    "description": "Green Pentagon Cannabis Native smokes resource with cigarette brand names shown on the menu and $25 carton notes where listed.",
    "eyebrow": "Native Smokes",
    "intro": "Green Pentagon Cannabis shoppers looking for Native smokes can use this page as a cleaner starting point. Brand names shown on the cigarette menu include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, Canadian Classics Silver, Nexus Full, Nexus Lights, and * Rolled Gold Lights. Some carton-style listings show around $25, but shoppers should check the current menu or staff before making the trip.",
    "cards": [
      {
    ...
    "sections": [
      {
        ...
        "body": "The cigarette menu may show brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, Canadian Classics Silver, Nexus Full, Nexus Lights, and * Rolled Gold Lights. The exact shelf can change, so treat this as a menu guide and confirm current options before choosing.",
        "bullets": [
          "Canadian Lights",
          "Canadian Full",
          "Putters",
  ...
  },
  {
    ...
    "title": "Green Pentagon Cannabis Native Cigarettes Guide",
    "seoTitle": "Green Pentagon Cannabis Native Cigarettes Guide | Brands and Carton Notes",
    "description": "A shopper-friendly Native cigarettes guide for Green Pentagon Cannabis, including brand names shown on the menu and $25 carton notes where listed.",
    "eyebrow": "Native Cigarettes Guide",
    "intro": "If Native cigarettes are part of the stop, start with the cigarette category and compare the current listings. Green Pentagon Cannabis menu brand names may include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, Canadian Classics Silver, Nexus Full, Nexus Lights, and * Rolled Gold Lights.",
    "cards": [
      {
        "title": "Cigarette Menu",
        "href": "/items/cigarettes",
    ...
    "sections": [
      {
        ...
        "body": "Look for the brand name first, then compare the posted price and any item notes. The menu may include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, Canadian Classics Silver, Nexus Full, Nexus Lights, and * Rolled Gold Lights.",
        "bullets": [
          "Canadian Lights",
          "Canadian Full",
          "Putters",
