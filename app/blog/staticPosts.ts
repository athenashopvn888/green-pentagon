...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Green Pentagon Cannabis Visit Without Guessing",
    "seoTitle": "Green Pentagon Cannabis Visit Guide | Weed Dispensary in Toronto",
    "seo_title": "Green Pentagon Cannabis Visit Guide | Weed Dispensary in Toronto",
    "metaDescription": "Plan a Toronto visit to Green Pentagon Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Toronto visit to Green Pentagon Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Green Pentagon Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for Green Pentagon Cannabis, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "seoTitle": "Green Pentagon Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Green Pentagon Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Green Pentagon Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Green Pentagon Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Green Pentagon Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Green Pentagon Cannabis.",
    "authorName": "Mina Five",
    "authorHandle": "@MinaPentagon",
    "authorRole": "House Writer",
    "author": "Mina Five",
  ...
  },
  {
    ...
    "seoTitle": "Green Pentagon Cannabis Menu Guide | Toronto Weed Store",
    "seo_title": "Green Pentagon Cannabis Menu Guide | Toronto Weed Store",
    "metaDescription": "Shop the Green Pentagon Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Green Pentagon Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Green Pentagon Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Green Pentagon Cannabis menu without turning the visit into a guessing game.",
    "authorName": "Parker Green",
    "authorHandle": "@ParkerPentagon",
    "authorRole": "House Writer",
    "author": "Parker Green",
