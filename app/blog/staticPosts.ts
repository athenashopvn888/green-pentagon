...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "relatedLinks": [
      ...
      {
        "title": "Green Pentagon Cannabis blog",
        "url": "/blog",
    ...
    "editorialRemark": {
      ...
      "authorName": "Mina Five",
      "authorHandle": "@MinaPentagon",
      "authorRole": "House Writer",
      "body": "The address check is not boring; it is the part that saves the trip. Store names and old tabs can blur together, so matching Queen St W, the phone number, and the current page is worth the minute. Use the live page before visiting."
    },
  ...
  },
  {
    ...
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Green Pentagon Desk",
      "authorHandle": "@GreenPentagonDesk",
  ...
  },
  {
    ...
    "oldTitle": "Green Pentagon Cannabis Local Visit Guide for Adults 19+",
    "wordCount": 536,
    "businessReviewFlags": []
  }
];
