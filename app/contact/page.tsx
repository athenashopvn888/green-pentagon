...
export const metadata: Metadata = {
  ...
  description:
    "Visit Green Pentagon Cannabis at 1267 Queen St W, GTA, ON M6K 2J2. Open 24 hours, 7 days a week. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "1267 Queen St W, GTA. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
