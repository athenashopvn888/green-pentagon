...
function previewStatus(): StaffStatus {
  return {
    store: { code: "GPC01", name: "Green Pentagon Cannabis" }, dayKey: "2026-07-23", submissions: [],
...
async function redrawImage(file: File) {
  ...
  return new File([blob], "gpc-staff-photo.jpg", { type: "image/jpeg", lastModified: Date.now() });
}
