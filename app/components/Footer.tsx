        ...
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            ...
            <p className={styles.desc}>
              Your Local Cannabis Dispensary At 1267 Queen St W, GTA. Visit
              Green Pentagon Cannabis For Premium Flower, Edibles, Vapes &amp; More.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.infoBlock}>
              ...
              <span>GTA, ON M6K 2J2</span>
              <span>Canada</span>
            </div>
            <div className={styles.infoBlock}>
              <span className={styles.infoLabel}>Phone:</span>
              <span><a href="tel:+14163885765" style={{color: "inherit"}}>(416) 388-5765</a></span>
            </div>
            <div className={styles.infoBlock}>
          ...
          <div className={styles.col}>
            ...
            <nav className={styles.links}>
              ...
              <Link href="/blog/green-pentagon-cannabis-local-visit-guide-2026">Local Visit Guide</Link>
              ...
              <Link href="/weed-dispensary-toronto/">Green Pentagon Cannabis Weed Dispensary in Toronto</Link>
