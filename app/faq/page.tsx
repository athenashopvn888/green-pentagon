...
export const metadata: Metadata = {
  title: "FAQ | Green Pentagon Cannabis",
  description: "Frequently asked questions about Green Pentagon Cannabis in Toronto, including store-page checks, menu categories, value shopping, and Native smokes where listed.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Green Pentagon Cannabis located?", a: "Green Pentagon Cannabis is listed at 1267 Queen St W, Toronto, ON M6K 2J2. Use the store page for directions and contact options before visiting." },
      { q: "What are the listed hours?", a: "Open Daily: 10:00 AM - 12:00 AM. Check the current store page or contact staff before visiting if timing matters." },
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Straight answers for shopping Green Pentagon Cannabis: store page first, menu category second, staff when the current detail matters.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call <a href="tel:+14163885765">(416) 388-5765</a> or use the store page before visiting.
            </p>
          </div>
        </div>
        <Footer />
