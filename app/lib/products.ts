...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Green Pentagon Cannabis?", a: "Yes! Visit us at 1267 Queen St W, GTA. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  CIGARETTES: {
    ...
    seoDescription: "Green Pentagon Cannabis is your go-to source for affordable native cigarettes in GTA. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1267 Queen St W in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Green Pentagon Cannabis, GTA.",
    seoDescription: "Green Pentagon Cannabis carries a curated selection of magic mushrooms and specialty products in GTA. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 1267 Queen St W for our full selection.",
    faqs: [
