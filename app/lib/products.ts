...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles Toronto | Green Pentagon Cannabis",
    seoIntro: "Browse edible options at Green Pentagon Cannabis. Compare product names, package details, posted notes, and current menu information before choosing.",
    seoDescription: "Edibles shop best when you compare the exact listing instead of guessing from an old example. Use the current menu at Green Pentagon Cannabis for names, package details, posted prices, and staff help when needed.",
    faqs: [
      { q: "What edibles are listed at Green Pentagon Cannabis?", a: "Use the current menu to compare edible names, package details, prices, and item notes." },
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Vapes Toronto | Green Pentagon Cannabis",
    seoIntro: "Compare vape listings at Green Pentagon Cannabis by product name, format, posted notes, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes Toronto | Green Pentagon Cannabis",
    seoIntro: "Use the disposable vape category at Green Pentagon Cannabis for current product names, formats, and menu notes.",
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Concentrates Toronto | Green Pentagon Cannabis",
    seoIntro: "Compare concentrates at Green Pentagon Cannabis by product type, name, posted notes, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoTitle: "Pre-Rolls Toronto | Green Pentagon Cannabis",
    seoIntro: "Shop pre-rolls at Green Pentagon Cannabis by comparing the current product name, format, package details, and posted notes.",
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories Toronto | Green Pentagon Cannabis",
    seoIntro: "Browse accessories at Green Pentagon Cannabis and compare the current menu notes before visiting.",
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | Green Pentagon Cannabis",
    seoIntro: "Browse specialty items only where they are listed on the current Green Pentagon Cannabis menu.",
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Toronto | Green Pentagon Cannabis",
    seoIntro: "Native smokes at Green Pentagon Cannabis in Toronto. The cigarette menu may show $25 carton-style listings and brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, and Canadian Classics Silver.",
    seoDescription: "Use the cigarette category to compare current Native smoke listings at Green Pentagon Cannabis. Specific brands, carton options, and prices can change, so check the current menu or ask staff before visiting.",
    faqs: [
      { q: "Does Green Pentagon Cannabis list Native cigarettes?", a: "Check the cigarette category for current Native smoke listings and brand names." },
